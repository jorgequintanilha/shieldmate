...
function setDaynightFunction() {
	var lang = localStorage.getItem("language") ? localStorage.getItem("language") : "en";
	sessionStorage.setItem("Daynight",2);
	sessionStorage.setItem("DaynightDisplay",0);
	document.getElementById("daynightBlock").addEventListener("click", function () {
		if (sessionStorage.getItem("Daynight") == 1 || sessionStorage.getItem("Daynight") == 2 ) {
			document.getElementById("txtDaynightDisplay").innerHTML = lang == "en" ? "Day" : "Dia";
			document.getElementById("daynightImg").src = "./img/daybound.png";
			sessionStorage.setItem("Daynight",0);
		}
		else if (sessionStorage.getItem("Daynight") == 0) {
			document.getElementById("txtDaynightDisplay").innerHTML = lang == "en" ? "Night" : "Noite";
			document.getElementById("daynightImg").src = "./img/nightbound.png";
			sessionStorage.setItem("Daynight",1);
		}
	}, false);
	document.getElementById("daynightBlock").addEventListener("long-press", function () {
		sessionStorage.setItem("Daynight",2);
		document.getElementById("txtDaynightDisplay").innerHTML = "- - - -";
		document.getElementById("daynightImg").src = "./img/daynight.png";
	}, false);
}
...
function setSettingsSidebarFunctions() {
  ...
  document.getElementById("btnSetSideBarDaynightToggle").addEventListener("click", function () {
    toggleClass(document.getElementById("daynightBlock"), "invisible");
    if (hasClass(document.getElementById("daynightBlock"), "invisible")) {
      document.getElementById("inpSetStatus").value = lang == "br" ? "DIA/NOITE DESATIVADO" : "DAY/NIGHT OFF";
    } else {
      document.getElementById("inpSetStatus").value = lang == "br" ? "DIA/NOITE ATIVADO" : "DAY/NIGHT ON";
    }
  }, false);
